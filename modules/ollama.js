...
const MOVEMENT_SPECS = [
  { key: 'cold_open', minWords: 100, targetWords: 130, description: 'Movement 1 — THE COLD OPEN. Open with what the listener can OBSERVE — match the opener to the topic category from <topic>.id prefix. FOR ca_*/et_*/lst_*/hi_*: open with a civilizational/societal observation (e.g. "Look at the men of your generation..." or "Look at any city tonight..." or "There is a system being built around you that no one named"). FOR sc_*/dr_*: open with wonder or a datum-vs-revelation pairing (e.g. "The discovery has a date. 1929. The verse has a date. 610."). FOR ml_*/tc_*: a personal scene IS allowed, but VARY IT — never the "It\'s 2 AM, your thumb scrolls..." template. FORBIDDEN: opening with phone/screen/thumb/scroll/notification — these are channel-template tropes the model has been over-fitted on; override the default and pick a topic-fit opener. NO mention of Islam yet, NO verse yet. End with one line that hints scripture already named what he just heard, without revealing what.' },
  { key: 'naming', minWords: 220, targetWords: 270, description: 'Movement 2 — THE NAMING. Name the disease. Reveal the Quranic verse from <sources> as the moment of recognition. MANDATORY framing before every quoted verse: `In the Quran, in Surah <surah_name> Ayah <verse_number>, God says: "<verse text>"`. Use the surah_name field from <sources> verbatim (e.g. "Ar-Ra\'d", "Al-Kahf"). The framing is non-negotiable — without it the verse blurs into your prose when the narrator reads it aloud. After the verse, insert [PAUSE], then strip away the comfortable interpretation. Make him understand it has always been about him, not historical figures. End with: "But this is not the warning. The warning is what comes next."' },
  { key: 'excavation', minWords: 450, targetWords: 540, description: 'Movement 3 — THE EXCAVATION. Go deeper into the Word. Reveal a second Quranic verse from <sources> if available. **If <sources> includes a hadith section, this movement is where you bring at least one hadith in** — especially for end-times, Dajjal, marriage/gaze, and topics where the Quran is brief but the Prophet ﷺ spoke at length. MANDATORY framings: new verse → `In the Quran, in Surah <surah_name> Ayah <verse_number>, God says: "..."`. New hadith → `In a hadith narrated in <collection> (Book X, Hadith Y), the Prophet ﷺ said: "..."`. Use the hadith\'s `reference` field from <sources> for the collection/book/hadith numbers. Show how the Prophets in the Quran faced the same trial — but in a way that mirrors the listener\'s exact situation. Weave 2-3 modern parallels from <modern_context> seamlessly. Pattern interrupt every 45 seconds: rhetorical question, contradiction of the listener\'s assumption, sudden pivot.' },
